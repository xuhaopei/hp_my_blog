<template>
  <div class="Sked">
        <el-dialog :title="toParentMsgPlanData.title" visible="true">
          <el-dialog
            width="30%"
          ...
          <el-table :data.sync="toParentMsgPlanData.planItems">
            <el-table-column
              type="index"
              width="50">
            </el-table-column>
...
export default {
  ...
  data(){
    return {
      ...
      toParentMsgPlanData:this.planData,
    }
  },
  watch:{
  ...
  beforeDestroy(){
    this.sendMsgToParent(this.toParentMsgPlanData);
  },
  methods:{
    edit(scope){
